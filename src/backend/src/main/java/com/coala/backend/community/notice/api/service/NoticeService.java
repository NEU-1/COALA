...
public interface NoticeService {
    public CommunityBaseResponseDto savePost (List<MultipartFile> image, NoticeRequestDto postDto) throws IOException;    // 요청 받은 Dto를 활용해서 post를 저장
    ...
    public CommunityBaseResponseDto updateNotice(List<MultipartFile> image, Long id, NoticeRequestDto dto); // id와 dto를 통해 새로운 내용으로 업데이트
}
